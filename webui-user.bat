...
@REM # set PYTHON=e:\Python\Python310\python.exe
# set GIT=
# set VENV_DIR=
...
set COMMANDLINE_ARGS=--xformers --no-half --no-half-vae --disable-nan-check --enable-insecure-extension-access --listen --reinstall-torch --profiles dev
